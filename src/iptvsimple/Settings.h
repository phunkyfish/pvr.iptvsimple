...
namespace iptvsimple
{
  ...
  private:
    ...
    PathType m_m3uPathType = PathType::REMOTE_PATH; //new
    std::string m_m3uPath = "";
    std::string m_m3uUrl = ""; //new
    bool m_cacheM3U = false;
    int m_startChannelNumber = 1;

    PathType m_epgPathType = PathType::REMOTE_PATH; //new
    std::string m_epgPath = "";
    std::string m_epgUrl = ""; //new
    bool m_cacheEPG = false;
    int m_epgTimeShiftMins = 0;
    bool m_tsOverride = true;

    PathType m_logoPathType = PathType::REMOTE_PATH; //new
    std::string m_logoPath = "";
    std::string m_logoBaseUrl = "";
    EpgLogosMode m_epgLogosMode = EpgLogosMode::IGNORE;
  };
} //namespace iptvsimple
